...
function Tech() {(
  ...
  return (
    <div className="Tech">
      <pre id="d"></pre>
      {/* <p>Je suis un développeur avide de découvertes, toujours prêt à explorer de nouveaux langages, frameworks et librairies pour créer des applications performantes.</p> */}
